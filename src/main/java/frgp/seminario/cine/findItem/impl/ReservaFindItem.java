...
public class ReservaFindItem {
	...
	{
		return dataAccess.getCustomQueryResult("SELECT asientos_id FROM Reserva JOIN Reserva_Asiento ON Reserva.id = Reserva_Asiento.Reserva_id WHERE Reserva.activo = 1 AND Reserva.cliente_email = '" + mail + "' AND Reserva.funcion_id =" +   idfuncion +" AND Reserva.fechaReserva LIKE '" + fecha + "%'").size();
	}
	//==========================
	//
	//==========================
